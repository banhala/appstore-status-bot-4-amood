...
const checkVersion = async (app, gist) => {
  ...
  if (!app.appID || phased_release_state.phased_release_state != gist.app_store_version_phased_release.phased_release_state || app.status != gist.status || app.app_store_version_phased_release.current_day_number != gist.app_store_version_phased_release.current_day_number) {
